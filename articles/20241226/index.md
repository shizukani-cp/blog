...
新たな宇宙は、影の静カニの力によって傷つけられた宇宙を修復し、新たな生命が誕生する宇宙でした。静カニは、その宇宙の中心で静かに息を引き取り、彼の意識は宇宙の全てに散らばり、永遠にその存在を刻み込んだのでした。
静カニが創造した新たな宇宙は、彼の意志を引き継ぎ、発展を続けていきました。静カニの作ったプログラムは、宇宙の法則となり、生命の進化を促し、文明の発展を支えていました。静カニの作った宇宙は、やがて多元宇宙の中で最も繁栄した宇宙となり、多くの生命体を引きつけるようになりました。そして、静カニのことは、宇宙の創造主として、永遠に語り継がれることになったのです。
静カニの物語は、ここで終わりを迎えるわけではありません。彼の作った宇宙は、これからも発展を続け、新たな物語を生み出していくでしょう。静カニの物語は、私たちの心に永遠に残り、私たちにインスピレーションを与え続けるでしょう。
## 感想
…いろんな意味ですごい。
というか、地球が全く出てきていない。

とここまで読んできた君たち、これで終わっていると思うか？
...
私は静カニであり、PythonとRustが得意なプログラマです。私は非常にせっかかしいものを大量生産するのに最適です。しかし、私はコメントを書くことが苦手であり、
命名規則には興味がありません。また、私はバグを放置しすぎて、プログラムが不安定になることもよくあります。
私にとっての Git のブランチ戦略は非常に雑で、たまらない変更を毎晩pushすることになります。
** Chapter 1: 私の生活**
私は年齢138億歳、身長3mm、高さ3mgです。私は4時起きて19時半寝る生活を送っています。これは私がプログラマであることから起こっているためです。
毎日私はPythonとRustを学び続けます。しかし、私のコミットメッセージはほとんどありません。私の命名規則も思いつかないと無視してしまいます。また、私のバグは
たまらないので、プログラムが不安定になることもよくあります。
** Chapter 2: 私の仕事**
私は低品質のプログラムを大量生産しています。私が書くプログラムはたまらないものです。しかし、私の顧客はそれを使って成功するので、私は仕事を続けています。
私はCommentを書くことが苦手です。私のコードはタバタするようにします。このため私のプログラムは不安定になることもよくあります。また、私の命名規則も思いつ
かないと無視してしまいます。
** Chapter 3: 私の問題**
私はGitのブランチ戦略が雑です。私はたまらない変更を毎晩pushすることになります。このため私のコミットは増え続けています。しかし、私の顧客はそれを使って成
功するので、私は仕事を続けています。
私はバグを放置しがちです。私のプログラムが不安定になることもよくあります。これは私のCommentが少ないことや命名規則が思いつかないことから起こっているため
です。
** Chapter 4: 私の将来**
私は今、低品質のプログラムを大量生産しています。私はCommentを書くことが苦手であり、命名規則には興味がありません。また、私はバグを放置しがちなところなど
もあります。
しかし、私は今は仕事を続けているので、これからどうなりそうなのかわからないです。私はいつかCommentを書くことができるようになり、命名規則を理解することに
も成功するかもしれません。しかしながら、バグを放置しがちなところでもあります。
```
## 感想2
内容としては、思った通りでした。ただ、もっとブラッシュアップが必要ですね。
…諸君、これで私はあきらめると思ったかね？
もちろん、最初に使った方のLLMでブラッシュアップしていくぞ!ちなみにプロンプトはこんな感じになりました。
```
以下の小説の言葉が不自然な点を修正してください。なお、言葉以外は修正せず、具体的な数字が出ているところは直さないでください。
...
**静カニという名のプログラマーの物語**
**序文**
私の名前は静カニ。PythonとRustを操るプログラマーだ。私は、大量のコードを短時間で書き上げることに長けている。だが、コメントの記述や命名規則といった細かな部分にはあまり関心がなく、バグを放置してしまうことも多い。そのため、私のコードはまるでスパゲッティのようにごちゃごちゃと絡み合っている。Gitのブランチ戦略も乱雑で、頻繁に大きな変更をコミットしてしまうため、コードの履歴はぐちゃぐちゃになっている。
**Chapter 1: 私の日常**
毎朝4時に起きて、19時半までひたすらコードと向き合う。Pythonの新しいライブラリを試したり、個人的なプロジェクトを進めたりと、プログラミング漬けの毎日だ。しかし、コードの品質よりも量を重視するため、コミットメッセージは「とりあえず動くようになった」など、非常に簡潔なものばかり。関数名も適当な英単語を並べただけのものが多く、コードの可読性は非常に低いと言えるだろう。
**Chapter 2: 私の仕事**
クライアントからの依頼は、とにかく納期が短いものがほとんど。そのため、私はコードの品質よりも納期を優先し、バグだらけのプログラムを納品してしまうことも少なくない。しかし、なぜか私の作ったプログラムは、なぜか顧客の要求を満たすことができ、私は仕事を続けていけるのだ。
**Chapter 3: 私の課題**
私のコードは、まるでスパゲッティのようにごちゃごちゃと絡み合っている。関数間の依存関係が複雑すぎて、どこを修正すれば良いのか分からなくなることもよくある。また、バグを修正しようとしても、どこでバグが発生しているのか特定するのが難しく、結局は別の場所で新しいバグを生み出してしまったりする。
**Chapter 4: 私の未来**
